...
object IdCardLayoutEngine {
    ...
    // Three ID-1 cards arranged vertically on an A4 page.
    // This preserves the requested physical 85.60 x 53.98 mm card size.
    fun createA4Sheet(sources: List<Bitmap>): Bitmap {
        ...
        val gap = A4Page.mmToPx(5f)
        val totalHeight = cardHeight * 3f + gap * 2f
    ...
    fun createA4Sheet(source: Bitmap): Bitmap =
        createA4Sheet(listOf(source))
}
