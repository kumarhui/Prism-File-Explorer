...
class MultiResultDialog : DialogFragment() {
    ...
    override fun onCreateView(inflater: android.view.LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        ...
        paths.forEachIndexed { index, path ->
            ...
            pages.addView(image, android.widget.LinearLayout.LayoutParams(
    ...
    override fun onStart() {
        ...
        dialog?.window?.let { window ->
            ...
            window.setLayout((resources.displayMetrics.widthPixels * 0.94f).toInt(), (resources.displayMetrics.heightPixels * 0.90f).toInt())
